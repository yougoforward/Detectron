...
from utils.model_convert_utils import convert_op_in_proto
from utils.model_convert_utils import op_filter
...
def parse_args():
    ...
    parser.add_argument(
        '--out_dir', dest='out_dir', help='output dir', default='../models',
        type=str)
    parser.add_argument(
        '--test_img', dest='test_img',
        help='optional test image, used to verify the model conversion',
        default='/home/long/github/detectron/demo/15673749081_767a7fa63a_k.jpg',
        type=str)
    parser.add_argument(
...
def run_model_cfg(args, im, check_blobs):
    ...
    with c2_utils.NamedCudaScope(0):
        ...
        t2=time.time()-t1
        print("model1 1000 times total time {}s".format(t2))
...
def main():
    ...
    # workspace.ResetWorkspace()
    # INIT_NET = "/home/long/github/detectron/models/model_init.pb"
    # PREDICT_NET = "/home/long/github/detectron/models/model.pb"
    ...
    # print('Loading test file {}...'.format(args.test_img))
    ...
    #         mutils.get_device_option_cpu()
    #     )
    # workspace.RunNet(net_def.SerializeToString())
    # scores = workspace.FetchBlob('score_nms')
    # classids = workspace.FetchBlob('class_nms')
    # boxes = workspace.FetchBlob('bbox_nms')
    device_opts = core.DeviceOption(caffe2_pb2.CUDA, 0)
