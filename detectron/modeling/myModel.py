...
def add_pyramid_enhancement(model, block_counts, freeze_at=2):
    return
def add_center_attention(model, block_counts, freeze_at=2):
    return
def add_scale_robust(model, block_counts, freeze_at=2):
    return
