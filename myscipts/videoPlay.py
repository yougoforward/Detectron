...
if __name__ == '__main__':
    ...
    ori_vid = ocv.VideoCapture('/media/E/广角汽车检测项目/video/newfile.avi')
    ...
    fourcc = 1196444237.0
    videoWriter = ocv.VideoWriter('/media/E/广角汽车检测项目/video/ObjectDetection.avi', int(fourcc), 3.0, (int(1920), int(540)))
    # init_windows()
    ...
    while True:
        try:
            ...
            ocv.putText(ori_frame, 'VI Lab', (40+960, 40), ocv.FONT_HERSHEY_SIMPLEX, 1,
                        (0, 0, 255), thickness=2, lineType=ocv.LINE_AA)
